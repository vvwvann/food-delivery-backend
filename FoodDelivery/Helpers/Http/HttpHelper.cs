  ...
  public class HttpHelper
  {
    ...
    public static async Task<ResponseHttp> PostAsync(string url, object data, Dictionary<string, string> headers = null)
    {
      string str = JsonConvert.SerializeObject(data,
           new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore, Formatting = Formatting.None, ContractResolver = Startup.DEFAULT_JSON_CONTRACT });
    ...
    public static async Task<ResponseHttp> PostAsync(string url, string data, Encoding encoding, string contentType, Dictionary<string, string> headers = null)
    {
    ...
    public static async Task<ResponseHttp> Delete(string url, object data, Dictionary<string, string> headers = null)
    {
      string str = JsonConvert.SerializeObject(data,
          new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore, Formatting = Formatting.None });
      ...
      StringContent content = new StringContent(str);
      content.Headers.ContentType = new MediaTypeHeaderValue("application/json");
      ResponseHttp http = await Delete(url, content, headers);
      content.Dispose();

      return http;
    }

    public static async Task<ResponseHttp> Delete(string url, string data, Dictionary<string, string> headers = null)
    {
      StringContent content = new StringContent(data);
      ResponseHttp response = await Delete(url, content, headers);
      content.Dispose();

      return response;
    }

    public static async Task<ResponseHttp> Delete(string url, HttpContent content, Dictionary<string, string> headers = null)
    {
      url = url.GetValidUri();
      if (url == null) return null;
    ...
    public static async Task<ResponseHttp> Delete(string url, Dictionary<string, string> headers = null)
    {
      return await Delete(url, (HttpContent)null, headers);
    }
